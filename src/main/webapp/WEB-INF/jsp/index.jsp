...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
  <h3>==========Check for Amazing Deals & Offers  on this Website=======</h3> 
...
<div class="row">
  <div class="col-md-4">
    <div class="thumbnail">
      <a href="${pageContext.request.contextPath}/resources/images/${prod.productId}.jpg">
        <img src="${pageContext.request.contextPath}/resources/images/${prod.productId}.jpg" alt="Lights" style="width:100%">
        <div class="caption">
          <p>${prod.productName}</p>
          <p>${prod.productCost}</p>
        </div>
      </a>
    </div>
  </div>
